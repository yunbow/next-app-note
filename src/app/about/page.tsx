...
export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">作成者について</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <section className="mt-8 pt-6 border-t">
            <h3 className="text-lg font-semibold mb-3">このサービスについて</h3>
            <p className="text-muted-foreground leading-relaxed">
              このサービスは、個人の学習目的で作成されたノートアプリケーションです。Next.js、TypeScript、Prisma、NextAuthなどのモダンな技術スタックを使用して開発されています。
            </p>
          </section>
        </CardContent>
      </Card>
