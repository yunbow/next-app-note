    ...
    <div className="mx-auto max-w-2xl p-4 space-y-6">
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          <p className="text-sm text-muted-foreground">最終更新日: 2026年4月13日</p>

          <section className="mt-6">
            <h2 className="text-xl font-semibold mb-3">第1条（適用）</h2>
            <p>本利用規約（以下「本規約」といいます）は、Note（以下「本サービス」といいます）の利用条件を定めるものです。ユーザーは、本規約に同意した上で、本サービスを利用するものとします。</p>
          </section>
          ...
          <section className="mt-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>「本サービス」とは、メモ・ノートの作成・管理を行うプラットフォームをいいます。</li>
              <li>「ユーザー」とは、本サービスを利用する全ての方をいいます。</li>
              <li>「投稿データ」とは、ユーザーが本サービスに作成したノート、メモ等のデータをいいます。</li>
            </ul>
          </section>
          ...
          <section className="mt-6">
            ...
            <p>本サービスは個人の学習目的で提供されており、商用サービスではありません。本サービスの利用により生じた損害について、運営者は一切の責任を負いません。本サービスは予告なく変更・停止する場合があります。</p>
          </section>
        </CardContent>
      </Card>
    </div>
